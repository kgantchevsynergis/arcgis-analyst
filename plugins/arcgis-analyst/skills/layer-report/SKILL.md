...
1. **Header** — portal host, date, and the exposure tag that scopes visibility (`mcp` unless this
   deployment uses another; the `tags` array on the items you retrieved shows the real one).
